...
struct qt_meta_stringdata_LanguageWidget_t {
    QByteArrayData data[1];
    char stringdata0[15];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_LanguageWidget_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_LanguageWidget_t qt_meta_stringdata_LanguageWidget = {
    {
QT_MOC_LITERAL(0, 0, 14) // "LanguageWidget"
...
const QMetaObject LanguageWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_LanguageWidget.data,
      qt_meta_data_LanguageWidget,  qt_static_metacall, nullptr, nullptr}
};
...
void *LanguageWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_LanguageWidget.stringdata0))
