...
QT_MOC_LITERAL(1, 14, 18), // "dialogClosedSignal"
QT_MOC_LITERAL(2, 33, 0), // ""
QT_MOC_LITERAL(3, 34, 20) // "onCloseButtonClicked"

    },
    "MessageDialog\0dialogClosedSignal\0\0"
...
void MessageDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->dialogClosedSignal(); break;
        ...
        {
            typedef void (MessageDialog::*_t)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MessageDialog::dialogClosedSignal)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject MessageDialog::staticMetaObject = {
    { &QFrame::staticMetaObject, qt_meta_stringdata_MessageDialog.data,
...
// SIGNAL 0
void MessageDialog::dialogClosedSignal()
{
